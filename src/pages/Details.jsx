...
function Details() {
  ...
  // handle error
  if (error) {
    return <Error onRetry={getProduct} />;
  }
  // handle loading
  if (loader) {
    return (
  ...
  return (
    <>
      {Object.keys(product).length > 0 ? (
        <div className="max-w-6xl mx-auto w-full px-6 min-h-screen mt-[30px] py-3">
          <div className="flex flex-col md:flex-row gap-16 mt-4">
            <div className="flex gap-3 justify-center md:justify-normal w-full md:w-auto">
              <div className="border border-green-500/30 p-2 max-w-100 rounded overflow-hidden">
            ...
            <div className="text-sm w-full md:w-1/2">
              ...
              <div className="flex items-center gap-0.5 mt-1">
                {Array(5)
                  .fill("")
                  .map((_, i) =>
                    Math.floor(product?.rating?.rate) > i ? (
                      <svg
                        key={i}
                        width="14"
                        height="13"
              ...
              <div className="flex items-center mt-10 gap-4 text-base">
                <button
                  ...
                  className="w-full py-3.5 cursor-pointer font-medium bg-green-500 text-white hover:bg-green-600 transition rounded-md"
                >
                  Add Cart
                </button>
              </div>
        ...
        <div className="alert flex items-center justify-center h-screen text-3xl">
          {" "}
          Product Not Found
        </div>
      )}
